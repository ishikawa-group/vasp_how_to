...
* POTCAR file can be generated by the Linux command:
    ...
    + `{POTCAR_directory}` **depends on the installation setting.
      If you don't know the directry, ask your superviser**. Usually, a directory like `potpaw...` is what you want.
